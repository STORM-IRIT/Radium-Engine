...
void run() {
    ...
    // Test getFileExt
    {
        ...
        RA_VERIFY( getFileExt( "aaa/bbb/xyz" ) == std::string( "" ), "File with no extension" );
        RA_VERIFY( getFileExt( "aaa/bbb/xyz." ) == std::string( "" ), "File with no extension" );
    }
    ...
    // Test getDirName
    {
        ...
        RA_VERIFY( getDirName( "/aaa/bbb/ccc.xyz" ) == std::string( "/aaa/bbb" ), "Absolute path" );
    ...
    // Test getBaseName
    {
        ...
        RA_VERIFY( getBaseName( "aaa/bbb.xyz", true ) == std::string( "bbb.xyz" ),
                   "Relative path" );
        RA_VERIFY( getBaseName( "aaa/bbb.xyz", false ) == std::string( "bbb" ), "Relative path" );
    ...
    RA_VERIFY( getDirName( path ) + "/" + getBaseName( path, false ) + "." + getFileExt( path ) ==
                   path,
               "Path reconstruction" );
