...
namespace PBD
{
	class ParticleData
	{
		...
		public:
            ...
            FORCE_INLINE Ra::Core::Vector3 &getPosition(const unsigned int i)
			{
				return m_x[i];
			}
            ...
            FORCE_INLINE Ra::Core::Vector3 &getPosition0(const unsigned int i)
			{
				return m_x0[i];
			}                    
            ...
            FORCE_INLINE Ra::Core::Vector3 &getLastPosition(const unsigned int i)
			{
				return m_lastX[i];
			}
            ...
            FORCE_INLINE Ra::Core::Vector3 &getOldPosition(const unsigned int i)
			{
				return m_oldX[i];
			}
            ...
            FORCE_INLINE Ra::Core::Vector3 &getVelocity(const unsigned int i)
			{
				return m_v[i];
			}
            ...
            FORCE_INLINE Ra::Core::Vector3 &getAcceleration(const unsigned int i)
			{
				return m_a[i];
			}
            ...
            FORCE_INLINE Scalar getMass(const unsigned int i) const
			{
				return m_masses[i];
			}

            FORCE_INLINE Scalar& getMass(const unsigned int i)
			{
				return m_masses[i];
			}
            ...
            FORCE_INLINE Scalar getInvMass(const unsigned int i) const
			{
				return m_invMasses[i];
			}

			FORCE_INLINE unsigned int getNumberOfParticles() const
			{
