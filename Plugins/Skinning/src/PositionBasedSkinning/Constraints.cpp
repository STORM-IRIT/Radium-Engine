...
// Distance Constraint
//////////////////////////////////////////////////////////////////////////
bool DistanceConstraint::initConstraint( SimulationModel& model, const unsigned int particle1,
...
bool DistanceConstraint::solvePositionConstraint( SimulationModel& model ) {
    ...
    const bool res = PositionBasedDynamics::solve_DistanceConstraint(
        x1, invMass1, x2, invMass2, m_restLength, model.getCompressionStiffness(),
        model.getStretchStiffness(), corr1, corr2 );
...
bool BindConstraint::initConstraint( const unsigned int particle,
                                     const unsigned int indexNearestBone,
...
bool BindConstraint::solvePositionConstraint( SimulationModel& model ) {
    ...
    const bool res = PositionBasedDynamics::solve_BindConstraint(
        positionParticle, startBone, endBone, invMass, m_restLength,
        model.getCompressionStiffness(), model.getStretchStiffness(), corr );
...
bool VolumeConstraint::initConstraint( SimulationModel& model, const unsigned int particle1,
                                       const unsigned int particle2, const unsigned int particle3,
...
bool VolumeConstraint::solvePositionConstraint( SimulationModel& model ) {
    ...
    const bool res = PositionBasedDynamics::solve_VolumeConstraint(
        x1, invMass1, x2, invMass2, x3, invMass3, x4, invMass4, m_restVolume,
        model.getNegVolumeStiffness(), model.getPosVolumeStiffness(), corr1, corr2, corr3, corr4 );
