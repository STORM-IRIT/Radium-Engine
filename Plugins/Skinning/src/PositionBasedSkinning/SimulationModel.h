...
namespace PBD
{
    ...
    public:                        
            ...
            void setStretchStiffness(const Scalar &stretchStiffness) { m_stretchStiffness = stretchStiffness; }

            Scalar getCompressionStiffness() const { return m_compressionStiffness; }
            void setCompressionStiffness(const Scalar &compressionStiffness) { m_compressionStiffness = compressionStiffness; }

            Scalar getNegVolumeStiffness() const { return m_negVolumeStiffness; }
            void setNegVolumeStiffness(const Scalar &negVolumeStiffness) { m_negVolumeStiffness = negVolumeStiffness; }

            Scalar getPosVolumeStiffness() const { return m_posVolumeStiffness; }
            void setPosVolumeStiffness(const Scalar &posVolumeStiffness) { m_posVolumeStiffness = posVolumeStiffness; }
            ...
            bool addBindConstraint (const unsigned int particle,
