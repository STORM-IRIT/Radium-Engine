...
template <>
inline unsigned int
hashFunction<NeighborhoodSearchCellPos*>( NeighborhoodSearchCellPos* const& key ) {
...
class NeighborhoodSearchSpatialHashing {
  public:
    NeighborhoodSearchSpatialHashing( const unsigned int numParticles = 0, const Real radius = 0.1,
    ...
    void neighborhoodSearch( Vector3r* x, const unsigned int numBoundaryParticles,
                             Vector3r* boundaryX );
    void update();
