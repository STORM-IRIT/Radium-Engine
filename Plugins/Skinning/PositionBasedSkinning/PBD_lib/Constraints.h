...
class DistanceConstraint : public Constraint {
  public:
    ...
    virtual bool initConstraint( SimulationModel& model, const unsigned int particle1,
...
class BindConstraint : public Constraint {
  public:
    ...
    virtual bool initConstraint( const unsigned int particle, const unsigned int indexNearestBone,
