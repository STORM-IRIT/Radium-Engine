...
class ObjectArray {
  ...
  public:
     ...
     */
    FORCE_INLINE T* arrayPointer() { return m_data; }

    /** Return the pointer of the data.
     */
    FORCE_INLINE const T* arrayPointer() const { return m_data; }

    /** Set size to zero but do not change capacity.
     */
    FORCE_INLINE void reset() { m_size = 0u; }
     ...
     */
    FORCE_INLINE unsigned int size() const { return m_size; }

    /** Return the capacity
     */
    FORCE_INLINE unsigned int capacity() const { return m_capacity; }

    FORCE_INLINE T* getData() { return m_data; }

    FORCE_INLINE const T* getData() const { return m_data; }
    ...
    FORCE_INLINE T& operator[]( const unsigned int i ) { return m_data[i]; }

    FORCE_INLINE const T& operator[]( const unsigned int i ) const { return m_data[i]; }
