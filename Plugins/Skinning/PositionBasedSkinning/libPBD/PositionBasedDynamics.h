...
class PositionBasedDynamics {
  public:
     ...
     * More information can be found in the following papers: \cite Mueller07, \cite BMOT2013, \cite
     * BMOTM2014, \cite BMM2015,
     *
     ...
     */
    static bool solve_DistanceConstraint( const Ra::Core::Vector3& p0, Scalar invMass0,
                                          const Ra::Core::Vector3& p1, Scalar invMass1,
                                          const Scalar restLength,
                                          const Scalar compressionStiffness,
                                          const Scalar stretchStiffness, Ra::Core::Vector3& corr0,
                                          Ra::Core::Vector3& corr1 );

    static bool solve_BindConstraint( const Ra::Core::Vector3& particle,
                                      const Ra::Core::Vector3& startBone,
                                      const Ra::Core::Vector3& endBone, Scalar invMassParticle,
                                      const Scalar restLength, const Scalar compressionStiffness,
                                      const Scalar stretchStiffness, Ra::Core::Vector3& corr );
     ...
     */
    static bool solve_VolumeConstraint( const Ra::Core::Vector3& p0, Scalar invMass0,
                                        const Ra::Core::Vector3& p1, Scalar invMass1,
                                        const Ra::Core::Vector3& p2, Scalar invMass2,
                                        const Ra::Core::Vector3& p3, Scalar invMass3,
                                        const Scalar restVolume, const Scalar negVolumeStiffness,
                                        const Scalar posVolumeStiffness, Ra::Core::Vector3& corr0,
                                        Ra::Core::Vector3& corr1, Ra::Core::Vector3& corr2,
                                        Ra::Core::Vector3& corr3 );

  private:
    static Ra::Core::Vector3 projectionPointSegment( const Ra::Core::Vector3& point,
