...
StrokeComponent::StrokeComponent( Ra::Engine::Scene::Entity* entity, Vector3Array strokePoints ) :
    Ra::Engine::Scene::Component( "Stroke Component", entity ),
    m_strokePts( strokePoints ) {}
...
void StrokeComponent::initialize() {
    ...
    auto renderObject1 = RenderObject::createRenderObject(
        "PolyMesh", this, RenderObjectType::Geometry, DrawPrimitives::LineStrip( m_strokePts, Vector4Array { m_strokePts.size(), {0,0,0.7,1} } ), Ra::Engine::Rendering::RenderTechnique {} );
