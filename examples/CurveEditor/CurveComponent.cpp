...
CurveComponent::CurveComponent( Ra::Engine::Scene::Entity* entity, Vector3Array ctrlPts, const std::string& name ) :
...
void CurveComponent::initialize() {
    ...
    auto renderObject1 = RenderObject::createRenderObject(
        "PolyMesh", this, RenderObjectType::Geometry, DrawPrimitives::LineStrip( bezierVertices, bezierColors ), Ra::Engine::Rendering::RenderTechnique {} );
    renderObject1->setMaterial( plainMaterial );
    addRenderObject( renderObject1 );

    auto renderObject2 = RenderObject::createRenderObject(
        "PolyMesh1", this, RenderObjectType::Geometry, DrawPrimitives::LineStrip( { m_ctrlPts[0], m_ctrlPts[1] }, {{0,0,0,1}} ), Ra::Engine::Rendering::RenderTechnique {} );
    renderObject2->setMaterial( plainMaterial );
    addRenderObject( renderObject2 );

    auto renderObject3 = RenderObject::createRenderObject(
        "PolyMesh1", this, RenderObjectType::Geometry, DrawPrimitives::LineStrip( { m_ctrlPts[2], m_ctrlPts[3] }, {{0,0,0,1}} ), Ra::Engine::Rendering::RenderTechnique {} );
