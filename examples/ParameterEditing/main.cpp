...
class UiBuilder : public DynamicVisitor
{
  public:
    UiBuilder( VariableSet& params, VariableSetEditor* pse, const nlohmann::json& constraints ) :
        ...
        addOperator<Vector2>( *this );
        addOperator<Vector3>( *this );
        addOperator<Vector4>( *this );
        addOperator<Matrix3>( *this );
...
int main( int argc, char* argv[] ) {
    ...
    UiBuilder builder { parameters, &editor, parameterSet_metadata };
