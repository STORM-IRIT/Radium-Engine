...
Matrix<double, 32, 1> shape_function( Vector3d const& xi,
                                      Matrix<double, 32, 3>* gradient = nullptr ) {
    ...
    if ( gradient )
    {
        ...
        dN( 9, 0 ) = _m3m9x2m2x * _1myt1pz, dN( 9, 1 ) = -_1mx2t1m3x * _1pz,
                 dN( 9, 2 ) = _1mx2t1m3x * _1my;
        dN( 10, 0 ) = _m3m9x2m2x * _1pyt1mz, dN( 10, 1 ) = _1mx2t1m3x * _1mz,
                  dN( 10, 2 ) = -_1mx2t1m3x * _1py;
        dN( 11, 0 ) = _m3m9x2m2x * _1pyt1pz, dN( 11, 1 ) = _1mx2t1m3x * _1pz,
                  dN( 11, 2 ) = _1mx2t1m3x * _1py;
        dN( 12, 0 ) = _p3m9x2m2x * _1myt1mz, dN( 12, 1 ) = -_1mx2t1p3x * _1mz,
                  dN( 12, 2 ) = -_1mx2t1p3x * _1my;
        dN( 13, 0 ) = _p3m9x2m2x * _1myt1pz, dN( 13, 1 ) = -_1mx2t1p3x * _1pz,
                  dN( 13, 2 ) = _1mx2t1p3x * _1my;
        dN( 14, 0 ) = _p3m9x2m2x * _1pyt1mz, dN( 14, 1 ) = _1mx2t1p3x * _1mz,
        ...
        dN( 17, 0 ) = -_1my2t1m3y * _1pz, dN( 17, 1 ) = _m3m9y2m2y * _1mxt1pz,
                  dN( 17, 2 ) = _1my2t1m3y * _1mx;
        dN( 18, 0 ) = -_1my2t1p3y * _1mz, dN( 18, 1 ) = _p3m9y2m2y * _1mxt1mz,
                  dN( 18, 2 ) = -_1my2t1p3y * _1mx;
        dN( 19, 0 ) = -_1my2t1p3y * _1pz, dN( 19, 1 ) = _p3m9y2m2y * _1mxt1pz,
                  dN( 19, 2 ) = _1my2t1p3y * _1mx;
        dN( 20, 0 ) = _1my2t1m3y * _1mz, dN( 20, 1 ) = _m3m9y2m2y * _1pxt1mz,
                  dN( 20, 2 ) = -_1my2t1m3y * _1px;
        dN( 21, 0 ) = _1my2t1m3y * _1pz, dN( 21, 1 ) = _m3m9y2m2y * _1pxt1pz,
                  dN( 21, 2 ) = _1my2t1m3y * _1px;
        dN( 22, 0 ) = _1my2t1p3y * _1mz, dN( 22, 1 ) = _p3m9y2m2y * _1pxt1mz,
...
Matrix<double, 32, 1> shape_function_( Vector3d const& xi,
                                       Matrix<double, 32, 3>* gradient = nullptr ) {
    auto res = Matrix<double, 32, 1>{};
...
CubicLagrangeDiscreteGrid::CubicLagrangeDiscreteGrid(
    AlignedBox3d const& domain, std::array<unsigned int, 3> const& resolution ) :
...
void CubicLagrangeDiscreteGrid::load( std::string const& filename ) {
    ...
    if ( !in.good() )
    {
        std::cerr << "ERROR: Discrete grid can not be loaded. Input file does not exist!"
                  << std::endl;
        return;
    }
...
unsigned int CubicLagrangeDiscreteGrid::addFunction( ContinuousFunction const& func, bool verbose,
...
#pragma omp for schedule( static ) nowait
                       ...
                       1000u ) )
            {
                std::async( std::launch::async, [&]() {
                    ...
                    std::cout << "\r"
                              ...
                              << 100.0 * static_cast<double>( counter ) /
    ...
    std::cout << "\rConstruction took " << std::setw( 15 )
              << static_cast<double>(
                     duration_cast<milliseconds>( high_resolution_clock::now() - t0_construction )
                         .count() ) /
                     1000.0
              << "s" << std::endl;
...
double CubicLagrangeDiscreteGrid::interpolate( unsigned int field_id, Vector3d const& x,
...
void CubicLagrangeDiscreteGrid::reduceField( unsigned int field_id, Predicate pred ) {
    ...
    auto vertex_to_cell =
        std::vector<std::set<std::pair<unsigned int, unsigned int>>>( coeffs.size() );
    ...
    std::sort( sort_pattern.begin(), sort_pattern.end(),
               [&]( unsigned int i, unsigned int j ) { return z_values[i] < z_values[j]; } );
...
void CubicLagrangeDiscreteGrid::forEachCell(
    ...
    for ( auto i = 0u; i < n; ++i )
    {
        ...
        domain.min() =
            m_domain.min() +
            Matrix<unsigned int, 3, 1>::Map( mi.data() ).cast<double>().cwiseProduct( m_cell_size );
