...
int main( int argc, char* argv[] ) {
    ...
    options.add_options()( "h,help", "Prints this help text" )(
        ...
        cxxopts::value<std::array<unsigned int, 3>>()->default_value( "10 10 10" ) )(
        "d,domain", "Domain extents (bounding box), format: \"minX minY minZ maxX maxY maxZ\"",
        cxxopts::value<AlignedBox3d>() )( "i,invert", "Invert SDF" )(
        "o,output", "Ouput file in cdf format",
        cxxopts::value<std::string>()->default_value( "" ) )(
        "input", "OBJ file containing input triangle mesh",
