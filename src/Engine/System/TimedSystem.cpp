 ...
 * c:\projects\radium-engine\src\engine\system\timedsystem.cpp(9): warning C4091: '': ignored on
 * left of 'Ra::Engine::BaseCouplingSystem<Ra::Engine::AbstractTimedSystem>' when no variable is
 * declared [C:\projects\Radium-Engine\build\src\radiumEngine.vcxproj]
 */
