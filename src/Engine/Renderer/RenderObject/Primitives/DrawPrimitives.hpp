...
RA_ENGINE_API MeshPtr Point( const Core::Math::Vector3& point, const Core::Math::Color& color,
                             Scalar scale = 0.1f );

/// Displays given line
RA_ENGINE_API MeshPtr Line( const Core::Math::Vector3& a, const Core::Math::Vector3& b,
                            const Core::Math::Color& color );

/// Displays given vector shown as an arrow originating from 'start'
RA_ENGINE_API MeshPtr Vector( const Core::Math::Vector3& start, const Core::Math::Vector3& v,
                              const Core::Math::Color& color );
...
RA_ENGINE_API MeshPtr Triangle( const Core::Math::Vector3& a, const Core::Math::Vector3& b,
                                const Core::Math::Vector3& c, const Core::Math::Color& color,
                                bool fill = false );

/// Displays a strip of n quads, starting at A and with directions X and Y.
RA_ENGINE_API MeshPtr QuadStrip( const Core::Math::Vector3& a, const Core::Math::Vector3& x,
                                 const Core::Math::Vector3& y, uint quads, const Core::Math::Color& color );

/// Displays circle computed with given center and radius,
/// in plane normal to given vector in wireframe
RA_ENGINE_API MeshPtr Circle( const Core::Math::Vector3& center, const Core::Math::Vector3& normal,
                              Scalar radius, uint segments, const Core::Math::Color& color );

/// Displays arc of a circle computed with given center, radius and angle
/// in plane normal to given vector in wireframe
RA_ENGINE_API MeshPtr CircleArc( const Core::Math::Vector3& center, const Core::Math::Vector3& normal,
                                 Scalar radius, Scalar angle, uint segments,
                                 const Core::Math::Color& color );

/// Displays sphere computed with given center and radius
RA_ENGINE_API MeshPtr Sphere( const Core::Math::Vector3& center, Scalar radius,
                              const Core::Math::Color& color );

/// Displays a capsule computed with given endpoints and radius.
RA_ENGINE_API MeshPtr Capsule( const Core::Math::Vector3& p1, const Core::Math::Vector3& p2, Scalar radius,
                               const Core::Math::Color& color );

/// Displays disk (filled circle) computed with given center and radius,
/// in plane normal to given vector in wireframe
RA_ENGINE_API MeshPtr Disk( const Core::Math::Vector3& center, const Core::Math::Vector3& normal, Scalar radius,
...
RA_ENGINE_API MeshPtr Normal( const Core::Math::Vector3& point, const Core::Math::Vector3& normal,
                              const Core::Math::Color& color, Scalar scale = 0.1f );
...
RA_ENGINE_API MeshPtr Frame( const Core::Math::Transform& frameFromEntity, Scalar scale = 0.1f );

/// Create a res*res square grid centered on center,
/// in plane normal to normal.
RA_ENGINE_API MeshPtr Grid( const Core::Math::Vector3& center, const Core::Math::Vector3& x,
                            const Core::Math::Vector3& y, const Core::Math::Color& color, Scalar cellSize = 1.f,
                            uint res = 10 );
