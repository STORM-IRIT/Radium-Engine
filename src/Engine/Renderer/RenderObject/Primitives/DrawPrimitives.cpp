...
MeshPtr Line( const Core::Math::Vector3& a, const Core::Math::Vector3& b,
...
MeshPtr Vector( const Core::Math::Vector3& start, const Core::Math::Vector3& v,
                const Core::Math::Color& color ) {
...
MeshPtr Triangle( const Core::Math::Vector3& a, const Core::Math::Vector3& b,
                  const Core::Math::Vector3& c, const Core::Math::Color& color, bool fill ) {
...
MeshPtr QuadStrip( const Core::Math::Vector3& a, const Core::Math::Vector3& x,
...
MeshPtr CircleArc( const Core::Math::Vector3& center, const Core::Math::Vector3& normal,
                   Scalar radius, Scalar angle, uint segments, const Core::Math::Color& color ) {
    Core::Container::Vector3Array vertices( segments );
    std::vector<uint> indices( segments );
...
MeshPtr Capsule( const Core::Math::Vector3& p1, const Core::Math::Vector3& p2, Scalar radius,
    ...
    Core::Math::Quaternion rot = Core::Math::Quaternion::FromTwoVectors(
        Core::Math::Vector3{0, 0, l / 2}, 0.5f * ( p1 - p2 ) );
...
MeshPtr Normal( const Core::Math::Vector3& point, const Core::Math::Vector3& normal,
                const Core::Math::Color& color, Scalar scale ) {
...
MeshPtr Grid( const Core::Math::Vector3& center, const Core::Math::Vector3& x,
              const Core::Math::Vector3& y, const Core::Math::Color& color, Scalar cellSize,
              uint res ) {
...
MeshPtr Spline( const Core::Math::Spline<3, 3>& spline, uint pointCount,
                const Core::Math::Color& color, Scalar scale ) {
    Core::Container::Vector3Array vertices;
