...
class RA_ENGINE_API Mesh final {
  ...
  public:
    ...
    void loadGeometry( const Core::Container::Vector3Array& vertices,
  ...
  private:
    ...
    std::array<Core::Container::Vector3Array, MAX_VEC3>
        m_v3Data; /// Additionnal vertex vector 3 data
    std::array<Core::Container::Vector4Array, MAX_VEC4>
        m_v4Data; /// Additionnal vertex vector 4 data
