...
namespace Ra
{
    namespace Engine
    {
        ...
        void FancyMeshComponent::addMeshRenderObject ( const Core::TriangleMesh& mesh, const std::string& name )
        {
        ...
        void FancyMeshComponent::addMeshRenderObject ( const Core::TriangleMesh& mesh,
                                                       ...
                                                       RenderTechnique* technique )
        {
            ...
            if ( technique->material->getMaterialType() == Material::MaterialType::MAT_TRANSPARENT )
            {
                renderObject->setRenderObjectType ( RenderObject::RenderObjectType::RO_TRANSPARENT );
            }
