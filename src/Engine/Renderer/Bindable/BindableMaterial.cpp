...
void Engine::BindableMaterial::bind(ShaderProgram *shader) const
{
    ...
    tex = m_material->getTexture(Material::TEX_DIFFUSE);
    if (tex != nullptr)
    {
        tex->bind(texUnit);
    ...
    tex = m_material->getTexture(Material::TEX_SPECULAR);
    if (tex != nullptr)
    {
        tex->bind(texUnit);
    ...
    tex = m_material->getTexture(Material::TEX_NORMAL);
    if (tex != nullptr)
    {
        tex->bind(texUnit);
    ...
    tex = m_material->getTexture(Material::TEX_SHININESS);
    if (tex != nullptr)
    {
        tex->bind(texUnit);
    ...
    tex = m_material->getTexture(Material::TEX_ALPHA);
    if (tex != nullptr)
    {
        tex->bind(texUnit);
