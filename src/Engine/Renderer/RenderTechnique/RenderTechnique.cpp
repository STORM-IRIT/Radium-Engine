...
namespace Ra {
    namespace Engine {
        ...
        const std::array<RenderTechnique::PassName, 3> allPasses =
        {RenderTechnique::Z_PREPASS, RenderTechnique::LIGHTING_OPAQUE, RenderTechnique::LIGHTING_TRANSPARENT};
        ...
        namespace EngineRenderTechniques
        {
            ...
            std::pair<bool, DefaultTechniqueBuilder> getDefaultTechnique(const std::string &name)
            {
                ...
                auto result = std::make_pair(false,
                                             [name](RenderTechnique &, bool) -> void
                                             {
