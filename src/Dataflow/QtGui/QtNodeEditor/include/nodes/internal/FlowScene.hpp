...
class NODE_EDITOR_PUBLIC FlowScene : public QGraphicsScene
{
  ...
  public:
    ...
    createConnection( PortType connectedPort, Node& node, PortIndex portIndex );
  ...
  public:
    ...
    void setSceneName( const QString& newname ) { _scenename = newname; }

    QString getSceneName() const { return _scenename; }
