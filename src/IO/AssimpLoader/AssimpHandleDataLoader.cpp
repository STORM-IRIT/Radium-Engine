...
/// LOAD
void AssimpHandleDataLoader::loadData(
    const aiScene* scene, std::vector<std::unique_ptr<Core::Asset::HandleData>>& data ) {
    data.clear();
...
void AssimpHandleDataLoader::loadHandleComponentData( const aiScene* scene, const aiMesh* mesh,
    ...
    Core::Container::AlignedStdVector<Core::Asset::HandleComponentData> component(
        size, Core::Asset::HandleComponentData() );
...
void AssimpHandleDataLoader::loadHandleComponentData(
    const aiScene* scene, const aiBone* bone, Core::Asset::HandleComponentData& data ) const {
...
void AssimpHandleDataLoader::loadHandleComponentData(
    const aiNode* node, Core::Asset::HandleComponentData& data ) const {
...
void AssimpHandleDataLoader::loadHandleFrame(
    const aiNode* node, const Core::Math::Transform& parentFrame,
