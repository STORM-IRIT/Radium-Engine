...
/// LOADING
void AssimpGeometryDataLoader::loadData(
...
void AssimpGeometryDataLoader::fetchType( const aiMesh& mesh,
...
void AssimpGeometryDataLoader::fetchVertices( const aiMesh& mesh,
...
/// EDGE
void AssimpGeometryDataLoader::fetchEdges( const aiMesh& mesh,
                                           Core::Asset::GeometryData& data ) const {
...
void AssimpGeometryDataLoader::fetchFaces( const aiMesh& mesh,
                                           Core::Asset::GeometryData& data ) const {
    const uint size = mesh.mNumFaces;
...
void AssimpGeometryDataLoader::fetchNormals( const aiMesh& mesh,
                                             Core::Asset::GeometryData& data ) const {
...
void AssimpGeometryDataLoader::fetchColors( const aiMesh& mesh,
                                            Core::Asset::GeometryData& data ) const {
    // TO DO
}
