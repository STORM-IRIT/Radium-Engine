...
namespace Ra {
    namespace IO {
        ...
        /// LOADING
        void AssimpLightDataLoader::loadData( const aiScene* scene, std::vector< std::unique_ptr< Asset::LightData > >& data ) {
            data.clear();
        ...
        void AssimpLightDataLoader::loadLightData(const aiScene* scene, const aiLight& light, Asset::LightData& data )
        {
