...
/**
 * The class FileManager gives the base common interface for handling
...
class [[deprecated]] FileManager {
  public:
    ...
    /**
     * Return the log of the last action performed.
     */
  ...
  protected:
    ...
    /**
     * Add a line in the log file. A newline character will be automatically added.
     */
    inline void addLogEntry( const std::string& text );

    /**
     * Add a warning line in the log file.
     */
    ...
    /**
     * Store the given data into a given file.
     * Return false if an error occurs, true otherwise.
     */
