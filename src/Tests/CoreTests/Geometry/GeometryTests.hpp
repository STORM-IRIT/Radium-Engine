...
namespace RaTests
{
    class GeometryTests : public Test
    {
        void run() override
        {
            ...
            // Test line queries.
            RA_UNIT_TEST(  areApproxEqual(pointToLineSq(a, a, b-a), Scalar(0.)), "distance from A to AB" );
            RA_UNIT_TEST(  areApproxEqual(pointToLineSq(b, a, b-a), Scalar(0.)), "distance from B to AB" );
            RA_UNIT_TEST(  areApproxEqual(pointToLineSq(na, a, b-a), Scalar(0.)), "point on the line.");
            RA_UNIT_TEST(  areApproxEqual(pointToLineSq(nb, a, b-a), Scalar(0.)), "point on the line.");
            RA_UNIT_TEST(  areApproxEqual(pointToLineSq(m + y, a, b-a), y.squaredNorm()), "point perpendicular to segment.");


            // Test segment queries
            RA_UNIT_TEST(  areApproxEqual(pointToSegmentSq(a, a, b-a),  Scalar(0.)), "Segment extremity" );
            RA_UNIT_TEST(  areApproxEqual(pointToSegmentSq(b, a, b-a), Scalar(0.)), "Segment extremity" );
            ...
            RA_UNIT_TEST( areApproxEqual(dmab.distanceSquared, Scalar(0.)), "Distance from AB midpoint to ABC");
            ...
            RA_UNIT_TEST( areApproxEqual(dmac.distanceSquared, Scalar(0.)), "Distance from AC midpoint to ABC");
            ...
            RA_UNIT_TEST( areApproxEqual(dmbc.distanceSquared, Scalar(0.)), "Distance from BC midpoint to ABC");
            ...
            RA_UNIT_TEST( areApproxEqual(dg.distanceSquared, Scalar(0.)), "Distance from centroid to ABC");
    ...
    class PolylineTests : public Test
    {
        void run() override
        {
            // 2 points polyline
            {
                ...
                RA_UNIT_TEST (Ra::Core::Math::areApproxEqual(p.distance(m), Scalar(0.)), "Distance fail" );
            }
            // 4 points polyline
            {
