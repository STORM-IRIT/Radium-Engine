...
class DistanceTests : public Test {
    void run() override {
        ...
        Scalar distLineToSeg = Ra::Core::Geometry::lineToSegSq( lineOrigin, lineDirection,
                                                                segCenter, segDirection, segExtent )
                                   .sqrDistance;
        ...
        Scalar distSegToTri =
            Ra::Core::Geometry::segmentToTriSq( segCenter, segDirection, segExtent, v ).sqrDistance;
