...
private:
  ...
  Scalar m_pixPerSec{
      10};        ///< Number of pixels used to display 1 second on the scale.
  ...
  /// Possible steps.
  static constexpr Scalar s_steps[s_nbSteps] = {
      0.01_ra, 0.02_ra, 0.05_ra, 0.1_ra,  0.2_ra,  0.5_ra,  1.0_ra,
      2.0_ra,  5.0_ra,  10.0_ra, 20.0_ra, 50.0_ra, 100.0_ra};
};
