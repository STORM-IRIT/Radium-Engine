...
#endif
// the default number of frames in the TimeSystem.
constexpr int timeSystemDefaultFramesNumber = 300;
...
BaseApplication::BaseApplication( int& argc,
    ...
    m_engine->registerSystem( "TimeSystem",
                              new Ra::Engine::TimeSystem( dt, timeSystemDefaultFramesNumber * dt ),
