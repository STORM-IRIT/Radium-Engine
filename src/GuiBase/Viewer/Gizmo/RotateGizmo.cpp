...
Core::Math::Transform RotateGizmo::mouseMove( const Engine::Camera& cam,
                                              const Core::Math::Vector2& nextXY, bool stepped ) {
...
void RotateGizmo::setInitialState( const Engine::Camera& cam,
                                   const Core::Math::Vector2& initialXY ) {
