 ...
 * It is responsible for storing the Camera used for rendering.
 */
class RA_GUIBASE_API CameraInterface : public QObject {
  ...
  public:
    ...
    /**
     * Reset the app Camera to the default one.
     * \note This method allows to have a quick fix of issue #378 before
     *       switching to Radium v2 development.
     *
     * \todo Have a cleaner camera management and control in the GuiBase Radium
     *       library. GuiBase Camera interface Must define a clean interface
     *       between the application and the Engine. This method is similar to
     *       the getCameraFromViewer, it should not be there.
     */
    ...
    /**
     * Return the attached Light if it exists, nullptr otherwise.
     */
  ...
  signals:
     ...
     * \note cameraPositionChanged() and cameraTargetChanged() are not emitted in such a case.
     */
  ...
  protected:
    ...
    Scalar m_targetedAabbVolume;     ///< Volume of m_targetedAabb.
