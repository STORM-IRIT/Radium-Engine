...
class RA_GUIBASE_API Viewer : public WindowQt, public KeyMappingManageable<Viewer>
{
  ...
  signals:
    ...
    void onMousePress( QMouseEvent* event );    // signal fired when receiving MousePressEvent
    void onMouseRelease( QMouseEvent* event );  // signal fired when receiving MouseReleaseEvent
