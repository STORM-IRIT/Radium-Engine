...
Pose applyTransformation( const Pose& pose,
...
void interpolateTransforms( const Math::Transform& a, const Math::Transform& b, const Scalar t,
                            Math::Transform& interpolated ) {
