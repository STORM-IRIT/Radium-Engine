 ...
 */
RA_CORE_API Pose applyTransformation(
    const Pose& pose, const Container::AlignedStdVector<Math::Transform>& transform );
...
RA_CORE_API void interpolateTransforms( const Ra::Core::Math::Transform& a,
                                        const Ra::Core::Math::Transform& b, Scalar t,
                                        Ra::Core::Math::Transform& interpolated );
