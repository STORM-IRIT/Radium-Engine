...
class RA_CORE_API Skeleton : public Handle {
  public:
    ...
    const Math::Transform& getTransform( const uint i, const SpaceType MODE ) const override;
    void setTransform( const uint i, const Math::Transform& T, const SpaceType MODE ) override;
     ...
     */
    Math::Vector3 projectOnBone( int boneIdx, const Math::Vector3& pos ) const;
