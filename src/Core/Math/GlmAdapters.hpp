...
namespace Ra {
namespace Core {
/** @name Converters from Eigen to glm.
...
inline glm::mat2 toGlm( const Matrix2f& m ) {
    return glm::mat2( m.coeff( 0, 0 ), m.coeff( 1, 0 ), m.coeff( 0, 1 ), m.coeff( 1, 1 ) );
}
...
/** @name Converters from glm to Eigen.
...
inline void fromGlm( const glm::mat3& m, Matrix3& out ) {
    out << m[0][0], m[1][0], m[2][0], m[0][1], m[1][1], m[2][1], m[0][2], m[1][2], m[2][2];
}
...
inline void fromGlm( const glm::mat4& m, Matrix4& out ) {
    out << m[0][0], m[1][0], m[2][0], m[3][0], m[0][1], m[1][1], m[2][1], m[3][1], m[0][2], m[1][2],
...
inline void fromGlm( const glm::mat3x2& m, Eigen::Matrix<Scalar, 3, 2>& out ) {
    out << m[0][0], m[1][0], m[0][1], m[1][1], m[0][2], m[1][2];
}
...
inline void fromGlm( const glm::mat2x4& m, Eigen::Matrix<Scalar, 2, 4>& out ) {
    out << m[0][0], m[1][0], m[2][0], m[3][0], m[0][1], m[1][1], m[2][1], m[3][1];
}
...
inline void fromGlm( const glm::mat4x2& m, Eigen::Matrix<Scalar, 4, 2>& out ) {
    out << m[0][0], m[1][0], m[0][1], m[1][1], m[0][2], m[1][2], m[0][3], m[1][3];
}
...
inline void fromGlm( const glm::mat4x3& m, Eigen::Matrix<Scalar, 4, 3>& out ) {
    out << m[0][0], m[1][0], m[2][0], m[0][1], m[1][1], m[2][1], m[0][2], m[1][2], m[2][2], m[0][3],
        m[1][3], m[2][3];
}
