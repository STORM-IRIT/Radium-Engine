...
namespace Core {
namespace Math {
/// \name Mathematical constants casted to Scalar.
...
/// \name Integer power functions.
/// Work for all numeric types which support multiplication and for which
/// T(1) is a valid expression.
