...
inline bool vsTriangle( const Ray& r, const Vector3 a, const Vector3& b, const Vector3& c,
                        std::vector<Scalar>& hitsOut );

// FIXME(Charly): Not efficient, intersecting against a kd-tree would be ways faster.
inline bool vsTriangleMesh( const Ray& r, const Geometry::TriangleMesh& mesh,
                            std::vector<Scalar>& hitsOut,
