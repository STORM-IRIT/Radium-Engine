...
/**
 * Return the new position of the vertices v_i given the LaplacianMatrix and a
 * set of weight, after a user-defined number of iterations. Within each iteration,
 * the new position is evaluated as the weighted sum of the iteration i and iteration i-1.
 */
