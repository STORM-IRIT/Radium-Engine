...
* Given the AdjacencyMatrix of the mesh, a Delta, a factor lambda and the number of iteration to be performed,
* the scalar u_i related to vertex v_i is computed as:
*
