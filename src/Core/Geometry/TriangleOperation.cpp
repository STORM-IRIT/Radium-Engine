...
Math::Vector3 triangleBarycenter( const Math::Vector3& p, const Math::Vector3& q,
...
Math::Vector3 triangleNormal( const Math::Vector3& p, const Math::Vector3& q,
                              const Math::Vector3& r ) {
...
Scalar triangleAngleRatio( const Math::Vector3& p, const Math::Vector3& q,
                           const Math::Vector3& r ) {
    const Scalar alphaP = Math::Vector::angle<Math::Vector3>( ( p - q ), ( p - r ) );
    const Scalar alphaQ = Math::Vector::angle<Math::Vector3>( ( q - p ), ( q - r ) );
    const Scalar alphaR = Math::Vector::angle<Math::Vector3>( ( r - p ), ( r - q ) );
...
Math::Vector3 barycentricCoordinate( const Math::Vector3& v, const Math::Vector3& p,
