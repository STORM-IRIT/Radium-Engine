...
inline RA_CORE_API Scalar pointToLineSq( const Math::Vector3& q, const Math::Vector3& a,
...
inline RA_CORE_API PointToTriangleOutput pointToTriSq( const Math::Vector3& q,
...
inline RA_CORE_API LineToSegmentOutput lineToSegSq( const Math::Vector3& lineOrigin,
                                                    Math::Vector3 lineDirection,
                                                    const Math::Vector3& segCenter,
