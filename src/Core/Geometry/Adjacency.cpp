...
AdjacencyMatrix uniformAdjacency( const uint point_size,
...
AdjacencyMatrix uniformAdjacency( const Container::VectorArray<Math::Vector3>& p,
                                  const Container::VectorArray<Triangle>& T ) {
...
TVAdj triangleUniformAdjacency( const Container::VectorArray<Math::Vector3>& p,
                                const Container::VectorArray<Triangle>& T ) {
