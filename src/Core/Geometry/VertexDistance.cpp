...
void vertexDistance( const Container::VectorArray<Math::Vector3>& v0,
                     const Container::VectorArray<Math::Vector3>& v1, std::vector<Scalar>& sqrDist,
...
void vertexDistance( const Container::VectorArray<Math::Vector3>& v0,
                     const Container::VectorArray<Math::Vector3>& v1, Scalar& sqrMin,
...
Scalar vertexDistance( const Container::VectorArray<Math::Vector3>& v0,
                       const Container::VectorArray<Math::Vector3>& v1 ) {
    const uint n = v0.size();
    Scalar sqrAvg = 0.0;
    for ( uint i = 0; i < n; ++i )
    {
