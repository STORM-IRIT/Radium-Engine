 ...
 *  - L( i, j ) = 0 otherwise (\f$ i \neq j \f$)
 *  - L( i, i ) = \f$ 0.5 * \sum( L( i, j ) ) \f$, \f$ i \neq j \f$
 *
...
/// \name Laplacian vector on a vertex's one-ring
/// \{
