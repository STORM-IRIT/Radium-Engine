#include <Core/Geometry/HalfEdge.hpp>
...
void getVertexFaces( const TriangleMesh& mesh, const HalfEdgeData& heData, VertexIdx vertex,
...
void getVertexNeighbors( const TriangleMesh& mesh, const HalfEdgeData& heData, VertexIdx vertex,
...
void getAdjacentFaces( const TriangleMesh& mesh, const HalfEdgeData& heData, TriangleIdx triangle,
...
void getVertexFirstRing( const TriangleMesh& mesh, const HalfEdgeData& heData, VertexIdx vertex,
