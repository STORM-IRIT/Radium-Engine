...
Container::VectorArray<Math::Vector3>
laplacianSmoothing( const Container::VectorArray<Math::Vector3>& v, const LaplacianMatrix& L,
...
void laplacianSmoothing( const Container::VectorArray<Math::Vector3>& v, const LaplacianMatrix& L,
                         const ScalarValue& weight, const uint iteration,
