#include <Core/Geometry/Diffusion.hpp>
#include <utility>
...
ScalarValue diffuseDelta( const AdjacencyMatrix& A, const Delta& delta, const Scalar lambda,
...
void diffuseDelta( const AdjacencyMatrix& A, const Delta& delta, const Scalar lambda,
