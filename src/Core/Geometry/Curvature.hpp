 ...
 */
Scalar gaussianCurvature( const Math::Vector3& v, const Container::VectorArray<Math::Vector3>& p,
                          const Scalar& area );
void gaussianCurvature( const Container::VectorArray<Math::Vector3>& p,
                        const Container::VectorArray<Triangle>& T, const AreaMatrix& A,
                        Container::VectorArray<Scalar>& K );
...
void gaussianCurvature( const Container::VectorArray<MaximumCurvature>& k1,
                        const Container::VectorArray<MinimumCurvature>& k2,
                        Container::VectorArray<Scalar>& K );
...
void meanCurvatureNormal( const Container::VectorArray<Math::Vector3>& laplacian,
                          const AreaMatrix& A, Container::VectorArray<Math::Vector3>& Hn );
...
void meanCurvature( const Container::VectorArray<Math::Vector3>& mean_curvature_normal,
                    Container::VectorArray<Scalar>& H );
...
void maxCurvature( const Container::VectorArray<MeanCurvature>& H,
                   const Container::VectorArray<GaussianCurvature>& K,
...
void minCurvature( const Container::VectorArray<MeanCurvature>& H,
                   const Container::VectorArray<GaussianCurvature>& K,
