 ...
 *       f( i, j ) = 0 , otherwise
 */
void uniformAdjacency( const Container::VectorArray<Math::Vector3>& p,
                       const Container::VectorArray<Triangle>& T, AdjacencyMatrix& Adj );
 ...
 */
RA_CORE_API AdjacencyMatrix cotangentWeightAdjacency(
...
// Utils::Adjacency meshOneRing( const Container::VectorArray< Math::Vector3 >& p, const
// Container::VectorArray< Triangle >& T
// );
