...
void uniformNormal( const Container::VectorArray<Math::Vector3>& p,
...
void angleWeightedNormal( const Container::VectorArray<Math::Vector3>& p,
                          const Container::VectorArray<Triangle>& T,
                          Container::VectorArray<Math::Vector3>& normal ) {
    const uint N = p.size();
    normal.clear();
...
void areaWeightedNormal( const Container::VectorArray<Math::Vector3>& p,
                         const Container::VectorArray<Triangle>& T,
                         Container::VectorArray<Math::Vector3>& normal ) {
    const uint N = p.size();
    normal.clear();
...
Math::Vector3 uniformNormal( const Math::Vector3& v,
...
Math::Vector3 angleWeightedNormal( const Math::Vector3& v,
                                   const Container::VectorArray<Math::Vector3>& one_ring ) {
    Math::Vector3 normal;
    normal.setZero();
    uint N = one_ring.size();
...
Math::Vector3 areaWeightedNormal( const Math::Vector3& v,
                                  const Container::VectorArray<Math::Vector3>& one_ring ) {
    Math::Vector3 normal;
    normal.setZero();
    uint N = one_ring.size();
