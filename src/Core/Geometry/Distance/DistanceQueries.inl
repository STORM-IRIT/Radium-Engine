...
namespace Ra
{
    namespace Core
    {
        namespace DistanceQueries
        {
            ...
            inline RA_CORE_API Scalar pointToTriSq( const Vector3& q, const Vector3& a, const Vector3& b, const Vector3& c, Vector3& triPoint)
            {
                /*
