#include <Core/Container/Grid.hpp>
...
TriangleMesh makeCylinder( const Math::Vector3& a, const Math::Vector3& b, Scalar radius,
                           uint nFaces ) {
    TriangleMesh result;
...
TriangleMesh makeTube( const Math::Vector3& a, const Math::Vector3& b, Scalar outerRadius,
                       Scalar innerRadius, uint nFaces ) {
...
TriangleMesh makeCone( const Math::Vector3& base, const Math::Vector3& tip, Scalar radius,
                       uint nFaces ) {
    TriangleMesh result;
