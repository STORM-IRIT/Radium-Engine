 ...
 */
AreaMatrix RA_CORE_API oneRingArea( const Container::VectorArray<Math::Vector3>& p,
 ...
 * Visualization and Mathematics III 2003
 */
void RA_CORE_API oneRingArea( const Container::VectorArray<Math::Vector3>& p,
                              const Container::VectorArray<Triangle>& T, AreaMatrix& A );
 ...
 * Visualization and Mathematics III 2003
 */
void RA_CORE_API barycentricArea( const Container::VectorArray<Math::Vector3>& p,
                                  const Container::VectorArray<Triangle>& T, AreaMatrix& A );
 ...
 * Visualization and Mathematics III 2003
 */
AreaMatrix RA_CORE_API voronoiArea( const Container::VectorArray<Math::Vector3>& p,
                                    const Container::VectorArray<Triangle>& T );
 ...
 * Visualization and Mathematics III 2003
 */
AreaMatrix RA_CORE_API mixedArea( const Container::VectorArray<Math::Vector3>& p,
                                  const Container::VectorArray<Triangle>& T );
 ...
 * Visualization and Mathematics III 2003
 */
Scalar RA_CORE_API oneRingArea( const Math::Vector3& v,
 ...
 * Visualization and Mathematics III 2003
 */
Scalar RA_CORE_API barycentricArea( const Math::Vector3& v,
                                    const Container::VectorArray<Math::Vector3>& p );
