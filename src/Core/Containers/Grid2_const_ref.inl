...
namespace Ra
{
    namespace Core
    {
        ...
        template<typename T>
        struct Grid2_ref_slice : public Grid<T, 2>
        {
            Grid2_ref_slice( const Grid2_ref_slice<T>& copy ) :
                ...
                _r1( copy._r1 )
            {
                //Grid<T, 2>::_size    = copy._size;
                //Grid<T, 2>::_pad_off = copy._pad_off;
            }

            Grid2_ref_slice( Grid<T, 3>& g, int slice, Range r0, Range r1 ) :
                Grid<T, 2>( Vector2i( r0.nb_elts(), r1.nb_elts() ) ),
                _grid_ref( g ),
                _slice( slice ),
                _r0( r0 ),
                _r1( r1 )
        ...
        protected:
            ...
            //    Grid<T, 2>::_size    = alloc_size;
            //    //Grid<T, 2>::_pad_off = padd_off;
            //}
        ...
        struct Grid2_ref_xy : public Grid2_ref_slice<T>
        {
            ...
            Grid2_ref_xy( Grid<T, 3>& g, Range x, Range y, int z ) :
            ...
            T& get_val( int x, int y )
            {
                ...
                assert( x >= 0 && y >= 0 );
                return Pt::_grid_ref.at( Vector3i( Pt::_r0._a + x, Pt::_r1._a + y, Pt::_slice ) );
            }
        ...
        struct Grid2_ref_xz : public Grid2_ref_slice<T>
        {
            ...
            Grid2_ref_xz( Grid<T, 3>& g, Range x, int y, Range z ) :
        ...
        struct Grid2_ref_yz : public Grid2_ref_slice<T>
        {
            ...
            Grid2_ref_yz( Grid<T, 3>& g, int x , Range y, Range z ) :
        ...
        template<typename T>
        Grid2_const_ref<T>::Grid2_const_ref( const Grid<T, 2>& g )
        {
            _grid_ref_allocated = false;
            _grid_ref_const = &g;
            _counter        = new Ref_counter();
        ...
        Grid2_const_ref<T>::make_xy( const Grid<T, 3>& g, Range x, Range y, int z )
        {
            ...
            ref._grid_ref_const = new Grid2_ref_xy<T>( const_cast<Grid<T, 3>&>( g ), x, y, z );
        ...
        Grid2_const_ref<T>::make_xz( const Grid<T, 3>& g, Range x, int y, Range z )
        {
            Grid2_const_ref<T> ref;
            ref._grid_ref_allocated = true;
            // see 'make_xy()' for the hack
            ref._grid_ref_const = new Grid2_ref_xz<T>( const_cast<Grid<T, 3>&>( g ), x, y, z );
            // Memory leak here counter already in default ctor
            //ref._counter        = new Ref_counter();
            //ref._counter->add_ref();
            return ref;
        ...
        Grid2_const_ref<T>::make_yz( const Grid<T, 3>& g, int x, Range y, Range z )
        {
            Grid2_const_ref<T> ref;
            ref._grid_ref_allocated = true;
            // see 'make_xy()' for the hack
            ref._grid_ref_const = new Grid2_ref_yz<T>( const_cast<Grid<T, 3>&>( g ), x, y, z );
            // Memory leak here counter already in default ctor
            //ref._counter        = new Ref_counter();
            //ref._counter->add_ref();
            return ref;
        ...
        {
            return ( *_grid_ref_const ).at( Vector2i( pos( 0 ), pos( 1 ) ) );
        }
