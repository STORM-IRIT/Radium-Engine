 ...
 */
RA_CORE_API AdjacencyList
extractAdjacencyList( const Container::VectorArray<Geometry::Edge>& edgeList );
 ...
 */
RA_CORE_API Container::VectorArray<Geometry::Edge>
extractEdgeList( const AdjacencyList& adj, const bool include_leaf = false );
