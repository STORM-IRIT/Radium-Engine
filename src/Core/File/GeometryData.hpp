...
class RA_CORE_API GeometryData : public AssetData {
  ...
  public:
    ...
    /// Set the duplicate table.
    inline void setDuplicateTable( const DuplicateTable& table );

    /// Toggle on/off loading the duplicates.
    ...
    /// Return true if duplicates have to be loaded.
