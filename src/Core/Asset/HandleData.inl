...
inline const Core::Container::AlignedStdVector<HandleComponentData>&
HandleData::getComponentData() const {
    return m_component;
}
...
inline void HandleData::setComponents(
    const Core::Container::AlignedStdVector<HandleComponentData>& components ) {
...
inline const Core::Container::AlignedStdVector<Core::Math::Vector2i>&
HandleData::getEdgeData() const {
    return m_edge;
}
...
inline void
HandleData::setEdges( const Core::Container::AlignedStdVector<Core::Math::Vector2i>& edgeList ) {
...
inline const Core::Container::AlignedStdVector<Core::Math::VectorNi>&
HandleData::getFaceData() const {
    return m_face;
}
...
inline void
HandleData::setFaces( const Core::Container::AlignedStdVector<Core::Math::VectorNi>& faceList ) {
