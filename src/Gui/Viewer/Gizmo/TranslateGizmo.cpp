...
TranslateGizmo::TranslateGizmo( Engine::Scene::Component* c,
...
Core::Transform TranslateGizmo::mouseMove( const Core::Asset::Camera& cam,
...
void TranslateGizmo::setInitialState( const Core::Asset::Camera& /*cam*/,
