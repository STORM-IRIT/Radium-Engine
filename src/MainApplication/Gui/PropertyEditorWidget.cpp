#include <MainApplication/Gui/PropertyEditorWidget.hpp>
#include <QVBoxLayout>
...
namespace Ra
{
    namespace Gui
    {
        ...
        void PropertyEditorWidget::updateValues()
        {
            CORE_ASSERT( m_props.size() == m_widgets.size(), "Widget/props inconsistency" );
        ...
        void PropertyEditorWidget::onChangedPosition( uint id, const Core::Vector3& v )
        {
        ...
        void PropertyEditorWidget::onChangedRotation( uint id, const Core::Quaternion& q )
        {
            CORE_ASSERT( m_currentEdit, "Nothing to edit" );
            CORE_ASSERT( sender() == m_widgets[id], "Sender error" );
        ...
        void PropertyEditorWidget::setEditable( Engine::EditableInterface* edit, uint propIdx )
        {
