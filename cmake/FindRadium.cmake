...
if ( RADIUM_ROOT_DIR )
  ...
  list(APPEND RADIUM_INCLUDE_DIRS "${RADIUM_SRC_DIR}" "${EIGEN3_INCLUDE_DIR}" "${PATATE_INCLUDE_DIR}" "${ASSIMP_INCLUDE_DIR}" "${GLBINDING_INCLUDE_DIR}" "${GLOBJECTS_INCLUDE_DIR}" "${OPENMESH_INCLUDE_DIR}")

  set( RADIUM_LIBRARIES )
  if ( RA_CORE_LIB AND RA_ENGINE_LIB AND RA_IO_LIB AND RA_GUIBASE_LIB AND ASSIMP_LIBRARIES AND GLBINDING_LIBRARIES AND GLOBJECTS_LIBRARIES AND OPENMESH_LIBRARIES)
    list(APPEND RADIUM_LIBRARIES "${RA_CORE_LIB}" "${RA_ENGINE_LIB}" "${RA_IO_LIB}" "${RA_GUIBASE_LIB}")
    set ( Radium_Libs_FOUND TRUE)
  endif ( RA_CORE_LIB AND RA_ENGINE_LIB AND RA_IO_LIB AND RA_GUIBASE_LIB AND ASSIMP_LIBRARIES AND GLBINDING_LIBRARIES AND GLOBJECTS_LIBRARIES AND OPENMESH_LIBRARIES)
