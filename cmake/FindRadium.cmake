...
if ( RADIUM_ROOT_DIR )
  ...
  find_library( RA_PLUGINBASE_LIB
    NAMES radiumPluginBase
    PATHS "${RADIUM_BUNDLE_DIRECTORY}/${CMAKE_BUILD_TYPE}/lib"
    )
  ...
  if (NOT GLBINDINGAUX_LIBRARIES)
      find_library(GLBINDINGAUX_LIBRARIES
              NAMES glbinding-aux glbinding-auxd
              PATHS "${RADIUM_SUBMODULES_INSTALL_DIRECTORY}/lib"
              )
      list(APPEND GLBINDING_LIBRARIES ${GLBINDINGAUX_LIBRARIES})
  endif (NOT GLBINDINGAUX_LIBRARIES)
  ...
  if(NOT OPENMESH_LIBRARIES)
    find_library ( OPENMESH_LIBRARIES
      NAMES OpenMeshCore
      PATHS ${RADIUM_ROOT_DIR} "${RADIUM_SUBMODULES_INSTALL_DIRECTORY}/lib"
      )
  ...
  ENDIF(NOT OPENMESH_INCLUDE_DIR)
  ...
  if ( RA_CORE_LIB AND RA_ENGINE_LIB AND RA_IO_LIB AND RA_GUIBASE_LIB AND RA_PLUGINBASE_LIB AND ASSIMP_LIBRARIES AND GLBINDING_LIBRARIES AND GLOBJECTS_LIBRARIES)
    list(APPEND RADIUM_LIBRARIES "${RA_CORE_LIB}" "${RA_ENGINE_LIB}" "${RA_IO_LIB}" "${RA_GUIBASE_LIB}" "${RA_PLUGINBASE_LIB}")
    set ( Radium_Libs_FOUND TRUE)
  endif ( RA_CORE_LIB AND RA_ENGINE_LIB AND RA_IO_LIB AND RA_GUIBASE_LIB AND RA_PLUGINBASE_LIB AND ASSIMP_LIBRARIES AND GLBINDING_LIBRARIES AND GLOBJECTS_LIBRARIES)
